 ...
 <div class="theme-form" enctype="multipart/form-data">
                        <div class="wizard-4" id="wizard">
                            <ul>
                                ...
                                <li><a href="#step-1">
                                        <h4>1</h4>
                                        <h5>Company</h5><small>Add company details</small>
                                    </a></li>
                                <li><a href="#step-2">
                                        <h4>2</h4>
                            ...
                            <div id="step-3">
                                <div class="wizard-title">
                                    <h2>Sign up to account</h2>
                                    <h5 class="text-muted mb-4">Company Identity</h5>
                                </div>
                                <div class="login-main">
                                    <div class="theme-form">
                                        <div class="form-group mb-3">
                                            <label for="exampleFormControlInput1">Registration No.</label>
                                            <input class="form-control" name="reg-no" type="text" required="required">
                                        </div>
                                        <div class="form-group mb-3">
